...
const PurchaseInvoicePage = async (props: {
  ...
  return (
    <ContentLayout>
      <AdminPageTopBar length={data?.length} title="Invoice">
        <AdminPageFilter />
        <RefreshButton />
        <AddButton>
          <Link href="/admin/purchase/invoice/new">Add Invoice</Link>
        </AddButton>
      </AdminPageTopBar>
      <AdminPageBody>
                  ...
                  <TableRow key={invoice.id}>
                    ...
                    <TableCell>
                      <Badge variant="secondary">
                        {invoice._count.PurchaseInvoiceItem} items
                      </Badge>
                    </TableCell>
                  </TableRow>
                ))
